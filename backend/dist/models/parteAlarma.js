...
exports.generarPDFParteAlarma = void 0;
const puppeteer_1 = __importDefault(require("puppeteer"));
/**
 * Función para generar PDF del parte de respuesta de alarma
 */
const generarPDFParteAlarma = (datos) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.generarPDFParteAlarma = generarPDFParteAlarma;
/**
 * Generar contenido HTML para el PDF del Parte de Respuesta de Alarma
 */
function generarHTMLParteAlarma(datos) {
