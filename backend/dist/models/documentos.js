...
const crearPlantilla_1 = require("../utils/crearPlantilla");
// Función para generar documento Word desde plantilla
const getPDF = (datos, imagenes) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!fs.existsSync(rutaPlantilla)) {
            ...
            (0, crearPlantilla_1.crearPlantillaBasica)(rutaPlantilla);
        }
        ...
        if (imagenes && imagenes.length > 0) {
            ...
            documentContent = yield agregarImagenesAlDocumento(documentContent, imagenes, zip);
        }
 ...
 */
function agregarImagenesAlDocumento(documentContent, imagenes, zip) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        existingIds.forEach(match => {
            var _a;
            const id = parseInt(((_a = match.match(/\d+/)) === null || _a === void 0 ? void 0 : _a[0]) || '0');
            if (id > maxId)
                maxId = id;
        });
 ...
 */
function asegurarNamespaces(documentContent) {
